...
export function CurrencyCombobox() {
    ...
    const [selectedOptions, setSelectedOptions] = React.useState<Currencies | null>(
        null
    );
    ...
    const selectOption = useCallback((currency: Currencies | null) => {
        if (!currency) {
            ...
            <SkeletonWrapper isLoading={userSettings.isFetching}>
                <Popover open={open} onOpenChange={setOpen}>
                    ...
                    <PopoverContent className="w-[200px] p-0" align="start">
                        <StatusList setOpen={setOpen} setSelectedOptions={selectOption} />
                    </PopoverContent>
                </Popover>
            </SkeletonWrapper>
        )
...
function StatusList({
    ...
    setSelectedOptions: (currency: Currencies | null) => void
}) {
    return (
        <Command>
