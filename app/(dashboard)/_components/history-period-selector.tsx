...
const YearSelector = (
    {period, setPeriod, years} : {period: Period; setPeriod: (period: Period) => void; years: GetHistoryPeriodsResponseType}
) => {
...
const MonthSelector = (
    {period, setPeriod} : {period: Period; setPeriod: (period: Period) => void;}
) => {
