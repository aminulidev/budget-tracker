        ...
        <div className="relative flex w-full flex-wrap gap-2 md:flex-nowrap">
            <SkeletonWrapper fullwidth={true} isLoading={statsQuery.isFetching}>
                <StatCard
                    ...
                    value={income}
                    title="Income"
                    icon={<TrendingUp className="h-12 w-12 items-center rounded-lg p-2 text-green-500 bg-green-400/10"/>}
                />
            </SkeletonWrapper>
            <SkeletonWrapper fullwidth={true} isLoading={statsQuery.isFetching}>
                <StatCard
            ...
            <SkeletonWrapper fullwidth={true} isLoading={statsQuery.isFetching}>
                <StatCard
                    ...
                    value={balance}
                    title="Balance"
                    icon={<Wallet className="h-12 w-12 items-center rounded-lg p-2 text-orange-500 bg-orange-400/10"/>}
                />
            </SkeletonWrapper>
        </div>
    );
...
const StatCard = ( {formatter, icon, title, value}: {formatter: Intl.NumberFormat; icon: ReactNode; title: String; value: number;}) => {
